...
- **QR Code Standardization**: QR codes now use consistent format (`booking.id.toString()`) matching scanner expectations throughout all emails, PDF tickets, and app interfaces
