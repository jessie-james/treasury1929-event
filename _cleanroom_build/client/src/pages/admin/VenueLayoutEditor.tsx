...
export function VenueLayoutEditor() {
  ...
  useEffect(() => {
    if (!selectedVenueId && venues.length > 0) {
      console.log("what is the venue", venues[0].id);
    ...
    <div className="container mx-auto p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Create and manage your venue layouts with interactive table
          positioning.
        </p>
      </div>
            ...
            <div className="border rounded-lg p-4 bg-gray-50 space-y-4">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  disabled={
                    createVenueMutation.isPending || !newVenueName.trim()
                  }
                >
              ...
              <CardContent className="py-12">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 mb-4">
                    This venue doesn't have a layout yet. Create one using the
                    designer below.
                  </p>
                </div>
              </CardContent>
