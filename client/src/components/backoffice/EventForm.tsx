...
export function EventForm({ event, onClose }: Props) {
  ...
  const [originalEventTime, setOriginalEventTime] = useState<string | null>(
    null,
  );
  ...
  const { mutate: saveEvent, isPending } = useMutation({
    mutationFn: async (data: EventFormData) => {
      ...
      const formattedData = {
        ...
        availableSeats: totalSeats, // Initially all tables are available
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        ...
                        this is normal client. Default: $130.00 test test test
                        test
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
